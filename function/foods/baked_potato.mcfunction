...
advancement revoke @s only mp.nutr:baked_potato

#triggers status effects
execute as @s run function mp.nutr:effects/execute {effect_init:"mp.nutr.bpt"}

#triggers active DP loss
execute as @s run function mp.nutr:dp/active {active_init:"mp.nutr.bpt", active_chance:"14.."}
