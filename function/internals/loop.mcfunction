...
execute as @a if score @s mp.nutr.breath matches 1.. run function mp.nutr:options/toggle_individual {tag:"mp.nutr.breath_off", setting:"mp.nutr.breath", confirm_on:"Breath particles have been toggled ON!", confirm_off:"Breath particles have been toggled OFF!"}
