...
advancement revoke @s only mp.nutr:tropical_fish

#triggers status effects
execute as @s run function mp.nutr:effects/execute {effect_init:"mp.nutr.tcl"}

#triggers active DP loss
execute as @s run function mp.nutr:dp/active {active_init:"mp.nutr.tcl", active_chance:"9.."}
