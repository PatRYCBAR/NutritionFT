...
advancement revoke @s only mp.nutr:cooked_porkchop

#triggers status effects
execute as @s run function mp.nutr:effects/execute {effect_init:"mp.nutr.cpc"}

#triggers active DP loss
execute as @s run function mp.nutr:dp/active {active_init:"mp.nutr.cpc", active_chance:"15.."}
