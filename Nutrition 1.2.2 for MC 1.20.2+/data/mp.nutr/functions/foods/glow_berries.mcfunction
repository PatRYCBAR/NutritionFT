...
advancement revoke @s only mp.nutr:glow_berries

#triggers status effects
execute as @s run function mp.nutr:effects/execute {effect_init:"mp.nutr.gwb"}

#triggers active DP loss
execute as @s run function mp.nutr:dp/active {active_init:"mp.nutr.gwb", active_chance:"18.."}
