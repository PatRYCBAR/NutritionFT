...
advancement revoke @s only mp.nutr:raw_chicken

#triggers status effects
execute as @s run function mp.nutr:effects/execute {effect_init:"mp.nutr.rck"}

#triggers active DP loss
execute as @s run function mp.nutr:dp/active {active_init:"mp.nutr.rck", active_chance:"5.."}
