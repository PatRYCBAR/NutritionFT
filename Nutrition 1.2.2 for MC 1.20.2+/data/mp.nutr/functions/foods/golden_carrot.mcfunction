...
advancement revoke @s only mp.nutr:golden_carrot

#triggers status effects
execute as @s run function mp.nutr:effects/execute {effect_init:"mp.nutr.gct"}

#triggers active DP loss
execute as @s run function mp.nutr:dp/active {active_init:"mp.nutr.gct", active_chance:"15.."}
